...
- Visium 10X data from Non Dementia Control (NDC) and Alzheimer's Disease (AD) patients [(Chen et al. 2021)](https://www.biorxiv.org/content/10.1101/2021.07.07.451554v1.full): data are available upon request from the authors.
